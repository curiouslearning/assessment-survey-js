...
export class Assessment extends BaseQuiz {
    ...
    logPuzzleCompletedEvent(answer, elapsed, theQ) {
        ...
        this.analyticsIntegration.track("answered" /* AnalyticsEventsType.ANSWERED */, {
            type: 'answered',
            dt: elapsed,
    ...
    logBucketCompletedEvent(bucket, passed) {
        this.analyticsIntegration.track("bucketCompleted" /* AnalyticsEventsType.BUCKET_COMPLETED */, {
    ...
    LogCompletedEvent(buckets = null, basalBucket, ceilingBucket) {
        ...
        this.analyticsIntegration.track("completed" /* AnalyticsEventsType.COMPLETED */, Object.assign({ type: 'completed', score: score, maxScore: buckets.length * 100, basalBucket: basalBucketID, ceilingBucket: ceilingBucketID }, (isSynapseUser && {
